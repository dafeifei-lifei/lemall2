const CONFIG = require('./config'),
    ...
    LIST_PATH = "./json/list.json",
    CLASS_PATH="./json/classdata.json";
...
app.use(async (req, res, next) => {
    ...
    req.listDATA = JSON.parse(await readFile(LIST_PATH));
    req.classDATA = JSON.parse(await readFile(CLASS_PATH));
    next();
});
