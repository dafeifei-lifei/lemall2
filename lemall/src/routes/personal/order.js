    ...
    render() {
        ...
        return <div className="orderBox">
            ...
            <div className="content">
                            ...
                            return <div className="order" key={index}>
                                ...
                                <div className="content">
                                    ...
                                    <div className="buyDetail">
                                        <p>类型：{item.name}</p>
                                        <p>{item.dec}</p>
                                        <p>购买日期：{`201${Math.ceil(Math.random() * 1) + 7}-${Math.ceil(Math.random() * 12)}-${Math.ceil(Math.random() * 30)}`}</p>
                                    </div>
                                </div>
                                <div className="pay">
                                    <p>{this.state.clickIndex === 2 ? "实付款" : (this.state.clickIndex === 1 ? "待付款" : (this.state.clickIndex === 0 ? "实付款" : null))}<span>￥{item.price}</span>
                                    </p>
                                </div>
                            </div>
                        })
                ...
                <div className={ary[this.state.clickIndex].length === 0 ? "emptyShow" : "empty"}>
